...
public class TextureVideoView extends ScalableTextureView
    ...
    private int mTargetSeekMesc;

    private boolean mSoundMute;
    private boolean mHasAudio;
    private boolean mSurfaceDestroyed = false;

    private VideoPlayStopCallback mVideoPlayStopCallback;

    private VideoPlayStartCallback mVideoPlayStartCallback;
    ...
    public void setVideoPlayStopCallback(VideoPlayStopCallback videoPlayStopCallback) {
        mVideoPlayStopCallback = videoPlayStopCallback;
    }

    public void setVideoPlayStartCallback(VideoPlayStartCallback videoPlayStartCallback) {
        mVideoPlayStartCallback = videoPlayStartCallback;
    }
...
//            mAudioManager.requestAudioFocus(null, AudioManager.STREAM_MUSIC, AudioManager.AUDIOFOCUS_LOSS);
            ...
            if (mVideoPlayStopCallback != null) {
                mVideoPlayStopCallback.onStopCallback();
            }
        }
    }
    ...
    public void start() {
        ...
        if (mUri != null && mSurface != null) {
            ...
            if (mVideoPlayStartCallback != null) {
                mVideoPlayStartCallback.onStartCallback();
            }
        }
    }
    ...
    public void onPrepared(final MediaPlayer mp) {
        ...
        if (isInPlaybackState()) {
            ...
            mCurrentState = STATE_PLAYING;
            mTargetState = STATE_PLAYING;
            if (mTargetSeekMesc>0){
                mMediaPlayer.seekTo(mTargetSeekMesc);
            }
        }
    ...
    public interface VideoPlayStopCallback {
        void onStopCallback();
    }

    public interface VideoPlayStartCallback {
